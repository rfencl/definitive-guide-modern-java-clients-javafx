...
public class TriangleAreaExample {
    public static void main(String[] args) {
        ...
        final NumberBinding p3p1 = Bindings.multiply(p3.x, p1.y);
        final NumberBinding p1p3 = Bindings.multiply(p1.x, p3.y);
        final NumberBinding p2p1 = Bindings.multiply(p2.x, p1.y);
        final NumberBinding p3p2 = Bindings.multiply(p3.x, p2.y);
        final NumberBinding sum1 = Bindings.add(p1p2, p2p3);
        final NumberBinding sum2 = Bindings.add(sum1, p3p1);
        final NumberBinding sum3 = Bindings.add(sum2, p3p1);
        final NumberBinding diff1 = Bindings.subtract(sum3, p1p3);
